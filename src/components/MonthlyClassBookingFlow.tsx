...
export default function MonthlyClassBookingFlow({
  ...
  const [bookingData, setBookingData] = useState<MonthlyBookingType | null>(
    null,
  );
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-center space-x-8">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {paymentSuccess ? <CheckCircle2 className="h-4 w-4" /> : "2"}
              </div>
              <span
                className={`text-sm font-medium ${
            ...
            <CardContent className="pt-12 pb-12">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-gray-600 max-w-md">
                  Your monthly class schedule has been successfully booked and
                  paid for. You'll receive {bookingData.totalSlots} classes this
                  month.
                </p>
              </div>
            </CardContent>
