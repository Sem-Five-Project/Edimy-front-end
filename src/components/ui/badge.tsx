  ...
  'inline-flex items-center rounded-full border-0 px-3 py-1.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 hover:scale-105 shadow-md hover:shadow-lg',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-gradient-to-r from-slate-100 to-gray-200 text-slate-700 hover:from-slate-200 hover:to-gray-300 focus:ring-slate-500',
        ...
        outline: 'border-2 border-slate-300 bg-white/80 text-slate-700 hover:border-purple-400 hover:bg-purple-50 hover:text-purple-700 focus:ring-purple-500',
        ghost: 'bg-transparent text-slate-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:text-purple-700',
      },
    },
    defaultVariants: {
      variant: 'default',
