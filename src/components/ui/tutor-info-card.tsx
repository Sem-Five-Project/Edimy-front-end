...
export function TutorInfoCard({
  tutor,
  className = "",
  experienceFormatter = (months: number) => {
  ...
  return (
    <Card
      className={`relative border-0 overflow-hidden rounded-2xl shadow-xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-md ${className}`}
    >
          ...
          <div className="flex-shrink-0 relative">
            <div className="relative w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full shadow-lg ring-2 ring-white/20 overflow-hidden group hover:scale-105 transition-all duration-300">
              ...
              <span className="text-white text-2xl font-bold flex items-center justify-center h-full">
                {(() => {
                  const displayName = tutor.firstName
                    ? `${tutor.firstName}${tutor.lastName ? " " + tutor.lastName : ""}`
                    : typeof (tutor as any).name === "string"
                      ? (tutor as any).name
                      : "Tutor";
            ...
            <div className="space-y-2">
              <div className="flex items-start justify-between">
                ...
                {tutor.isVerified && (
                  <Badge
                    variant="secondary"
                    className="bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-200 border-green-200 dark:border-green-800/50"
                  >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  {(tutor as any).reviews ?? 0} reviews)
                </span>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 mb-1">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white">
                    {experienceFormatter(
                      (tutor as any).experienceMonths ?? tutor.experience ?? 0,
                    )}
                  </span>
                </div>
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <span className="flex-1">
                        {(subject as any).name ?? subject.subjectName}
                      </span>
