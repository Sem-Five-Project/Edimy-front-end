    ...
    if (userRole === "ADMIN") {
      return [
        ...
        },
        {
          ...
          icon: FileText,
          path: "/dashboard/admin/tutor-applications",
        },
        {
          id: "analytics",
          label: "Analytics",
  ...
  const NavItem = ({ item }: { item: any }) => {
    ...
    return (
      <li>
        ...
        >
          {/* Active indicator */}
          {isActive && <div className="absolute left-0 top-0 bottom-0 w-1 " />}
          ...
          {!isCollapsed && (
            <>
              ...
              {isActive && (
                <ChevronRight className="w-4 h-4 ml-auto transition-all duration-300 opacity-100 translate-x-1" />
              )}
            </>
          )}
        </button>
