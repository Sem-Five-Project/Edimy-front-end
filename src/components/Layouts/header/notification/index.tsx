  ...
  return (
    ...
    >
      ...
      >
        <span className="relative">
          ...
          {isDotVisible && (
            <span
              className={cn(
                "absolute right-0 top-0 z-1 w-2 h-2 rounded-full bg-red-light ring-2 ring-gray-2 dark:ring-dark-3",
              )}
            >
      ...
      <DropdownContent
        ...
        className="border border-stroke bg-white px-3.5 py-3 shadow-md dark:border-dark-3 dark:bg-gray-900 min-[350px]:min-w-[20rem]"
      >
