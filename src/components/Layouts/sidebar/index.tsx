...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "max-w-[290px] overflow-hidden border-r border-stroke bg-white shadow-1 transition-[width] duration-200 ease-linear dark:border-stroke-dark dark:bg-gray-900 dark:shadow-card",
