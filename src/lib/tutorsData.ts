...
export async function getTutors(filters?: {
  ...
  const allTutors: Tutor[] = [
    ...
    },
    {
      ...
      subjects: [
        { subject: 'Computer Science', hourlyRate: 55, experienceLevel: 'Expert' },
        { subject: 'Python Programming', hourlyRate: 50, experienceLevel: 'Expert' },
        { subject: 'Data Structures', hourlyRate: 52, experienceLevel: 'Expert' }
      ],
      availability: [
    ...
    },
    {
      ...
      subjects: [
        ...
        { subject: 'English Literature', hourlyRate: 38, experienceLevel: 'Advanced' }
      ],
      availability: [],
      totalSessions: 32,
      upcomingSessions: 0,
      totalEarnings: 1140.00,
      averageRating: 4.2,
      totalReviews: 28,
      isVerified: false,
    ...
    },
    {
      ...
      subjects: [
        ...
        { subject: 'Organic Chemistry', hourlyRate: 52, experienceLevel: 'Expert' },
    ...
    },
    {
      ...
      subjects: [
        ...
        { subject: 'Digital Design', hourlyRate: 42, experienceLevel: 'Advanced' }
      ],
      availability: [
        { day: 'Saturday', startTime: '10:00', endTime: '18:00', isAvailable: true },
        { day: 'Sunday', startTime: '12:00', endTime: '17:00', isAvailable: true },
      ],
      totalSessions: 8,
      upcomingSessions: 3,
...
export async function getTutorSessions(tutorId: string): Promise<TutorSession[]> {
  // Fake delay
...
export async function getTutorEarnings(tutorId: string): Promise<TutorEarning[]> {
  // Fake delay
  ...
  const reviews: TutorReview[] = [
    {
      ...
      subject: 'Mathematics',
      rating: 5,
      review: 'Dr. Johnson is an amazing tutor! She explains complex mathematical concepts in a way that\'s easy to understand.',
    ...
    },
    {
      ...
      subject: 'Calculus',
      rating: 4,
      review: 'Very knowledgeable and patient. Helped me improve my calculus grades significantly.',
    ...
    },
    {
      ...
      subject: 'Statistics',
      rating: 5,
      review: 'Outstanding tutor with excellent teaching methods. Highly recommend!',
...
export async function updateTutorStatus(tutorId: string, status: Tutor['status']): Promise<boolean> {
  // Fake delay
  await new Promise((resolve) => setTimeout(resolve, 500));
...
export async function bulkUpdateTutors(tutorIds: string[], action: 'suspend' | 'activate' | 'delete'): Promise<boolean> {
  // Fake delay
  await new Promise((resolve) => setTimeout(resolve, 1000));
...
export async function getAdminActions(tutorId?: string): Promise<AdminAction[]> {
  // Fake delay
  await new Promise((resolve) => setTimeout(resolve, 500));
