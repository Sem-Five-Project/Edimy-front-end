...
export async function getStudentSessions(studentId: string): Promise<SessionHistory[]> {
  // Fake delay
...
export async function getStudentPayments(studentId: string): Promise<PaymentHistory[]> {
  // Fake delay
...
export async function updateStudentStatus(studentId: string, status: Student['status']): Promise<boolean> {
  // Fake delay
  await new Promise((resolve) => setTimeout(resolve, 500));
...
export async function bulkUpdateStudents(studentIds: string[], action: 'suspend' | 'activate' | 'delete'): Promise<boolean> {
  // Fake delay
  await new Promise((resolve) => setTimeout(resolve, 1000));
