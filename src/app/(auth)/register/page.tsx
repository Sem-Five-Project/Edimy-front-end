...
//                       Learn from verified professionals and subject matter
//                       experts
//                     </p>
//                   </div>
//                 </div>
...
//                       <div
//                         className={`p-3 rounded-xl transition-colors ${formData.role === "TUTOR" ? "bg-slate-900 text-white" : "bg-slate-200 text-slate-700"}`}
//                       >
//                         {formData.role === "TUTOR" ? (
...
//                         <Label
//                           htmlFor="userType"
//                           className="cursor-pointer font-semibold text-lg text-slate-900"
//                         >
//                           I want to be a{" "}
...
//                           />
//                         </div>
//                         <span className="text-sm font-medium min-w-16 text-slate-700">
