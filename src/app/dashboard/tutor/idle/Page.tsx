    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
      <Card className="w-full max-w-md text-center">
        <CardHeader>
          ...
          <CardDescription>
            Your tutor application is currently being reviewed by our admin
            team.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <p className="text-sm text-blue-800 dark:text-blue-200">
              Thank you for submitting your application, {user?.firstName}{" "}
              {user?.lastName}. We'll review your credentials and resume
              shortly.
            </p>
          </div>
            ...
            <div className="flex items-center space-x-3 text-left p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We've received your tutor application
                </p>
              </div>
            </div>
