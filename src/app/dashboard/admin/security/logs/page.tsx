...
import { Search, Filter, MoreHorizontal, Eye, AlertTriangle, User, Calendar, Monitor, MapPin, Globe, Shield, Clock } from "lucide-react";
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{loginStats.totalLogins.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{loginStats.successfulLogins.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">{loginStats.successRate}% success rate</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Monitor user login activity and system access for security compliance.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Search and Filters */}
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{currentLog.userId}</p>
                ...
                <div>
                  ...
                  <Badge variant={getRoleBadgeVariant(currentLog.role)} className="w-fit mt-1">
                    {currentLog.role}
                  </Badge>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{currentLog.sessionDuration || 'N/A'}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{currentLog.browser}</p>
              </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  ...
                  {currentLog.status === 'Failed' && currentLog.failureReason && (
                    <div className="mt-1 p-2 bg-red-50 dark:bg-red-900/20 rounded-lg">
                      <p className="text-sm text-red-600">Failure Reason: {currentLog.failureReason}</p>
                    </div>
                  )}
                </div>
              </div>
