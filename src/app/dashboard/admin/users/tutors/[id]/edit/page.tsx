        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-lg font-medium">{tutor.firstName} {tutor.lastName}</p>
            </div>
            <div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Verified tutors are displayed with a verification badge to students
              </p>
            </div>

            {/* Status */}
            <div className="space-y-2">
              <Label htmlFor="status" className="text-base font-medium">Account Status</Label>
              <Select
                value={formData.status}
                onValueChange={(value: 'ACTIVE' | 'SUSPENDED') => handleInputChange('status', value)}
              >
                ...
                <SelectContent className="bg-slate-800 border-slate-700">
                  <SelectItem value="ACTIVE" className="text-green-300 hover:bg-slate-700 focus:bg-slate-700 focus:text-green-300">
                    Active
                  </SelectItem>
                  <SelectItem value="SUSPENDED" className="text-yellow-300 hover:bg-slate-700 focus:bg-slate-700 focus:text-yellow-300">
                    Suspended
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            {/* Rating */}
            <div className="space-y-2">
              <Label htmlFor="rating" className="flex items-center gap-2 text-base font-medium">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Override the calculated rating (0-5). Leave at 0 to use calculated rating.
              </p>
            </div>

            {/* Admin Notes */}
            <div className="space-y-2">
              <Label htmlFor="adminNotes" className="flex items-center gap-2 text-base font-medium">
              ...
              />
              <p className="text-xs text-muted-foreground">
                These notes are only visible to administrators and are not shared with tutors or students
              </p>
            </div>
          </CardContent>
        </Card>
