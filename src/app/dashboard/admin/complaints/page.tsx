...
import { Search, MoreHorizontal, Eye, MessageSquare, AlertTriangle, X, User, Calendar, Hash } from "lucide-react";
...
const mockComplaints: Complaint[] = [
  {
    ...
    description: 'The tutor was consistently late and unprepared for sessions. I feel like I wasted my money.',
    status: 'In Progress',
    priority: 'Medium',
    ...
    responses: [
      {
        ...
        author: 'Alex Chen',
        authorType: 'User',
        message: 'The tutor was consistently late and unprepared for sessions. I feel like I wasted my money.',
      ...
      },
      {
        ...
        authorType: 'Admin',
        message: 'Thank you for reporting this issue. We are investigating the matter and will contact the tutor for their response.',
  ...
  },
  {
    ...
    description: 'Student was disrespectful and used inappropriate language during the session.',
    status: 'Resolved',
    priority: 'High',
    ...
    responses: [
      {
        ...
        authorType: 'User',
        message: 'Student was disrespectful and used inappropriate language during the session.',
      ...
      },
      {
        ...
        author: 'Admin Support',
        authorType: 'Admin',
        message: 'We have reviewed the session recording and will issue a warning to the student.',
  ...
  },
  {
    ...
    description: 'I was charged for a session that the tutor cancelled at the last minute.',
    status: 'Open',
    priority: 'Medium',
    ...
    responses: [
      {
        ...
        author: 'Emma Wilson',
        authorType: 'User',
        message: 'I was charged for a session that the tutor cancelled at the last minute.',
  ...
  },
  {
    ...
    responses: [
      ...
      },
      {
        ...
        authorType: 'Admin',
        message: 'This is a serious allegation. We are conducting a full investigation and have temporarily suspended the tutor.',
...
export default function ComplaintManagement() {
  ...
  const filteredComplaints = complaints.filter(complaint => {
    ...
    return matchesSearch && matchesIssueType && matchesStatus && matchesPriority;
  });
  ...
  const handleBulkClose = () => {
    setComplaints(complaints.map(complaint => 
      selectedComplaints.includes(complaint.id) 
        ? { ...complaint, status: 'Closed' as const, lastUpdated: new Date().toISOString().split('T')[0] }
        : complaint
    ));
    setSelectedComplaints([]);
  };
  ...
  const handleBulkEscalate = () => {
    setComplaints(complaints.map(complaint => 
      selectedComplaints.includes(complaint.id) 
        ? { ...complaint, priority: 'Critical' as const, lastUpdated: new Date().toISOString().split('T')[0] }
        : complaint
    ));
    setSelectedComplaints([]);
  };
  ...
  const handleSendResponse = () => {
    ...
    const updatedComplaint = {
      ...
      status: (resolutionType && resolutionType !== 'none') ? 'Resolved' as const : 'In Progress' as const,
      ...((resolutionType && resolutionType !== 'none') && { 
        resolution: responseMessage,
        resolutionType: resolutionType as 'Refund' | 'Warning' | 'Suspension' | 'No Action'
      })
    };
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Handle user complaints and dispute resolution for students and tutors.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {/* Search and Filters */}
                  ...
                  <TableRow key={complaint.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="font-medium">{complaint.submittedBy.name}</div>
                    ...
                    <TableCell>
                      <div className="flex items-center">
                        <User className="mr-2 h-4 w-4 text-muted-foreground" />
                        <div>
                          <div className="font-medium">{complaint.against.name}</div>
                          <Badge variant="outline" className="text-xs">
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="bg-white dark:bg-gray-800 border shadow-lg">
                          ...
                          <DropdownMenuItem onClick={() => openViewDialog(complaint)}>
                            <Eye className="mr-2 h-4 w-4" />
                            View Details
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => openResponseDialog(complaint)}>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge variant={getStatusBadgeVariant(currentComplaint.status)} className="w-fit mt-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge variant={getPriorityBadgeVariant(currentComplaint.priority)} className="w-fit mt-1">
                ...
                <div>
                  ...
                  <div className="mt-1 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <Badge variant="default">{currentComplaint.resolutionType}</Badge>
                    </div>
      ...
      <Dialog open={isResponseDialogOpen} onOpenChange={setIsResponseDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="resolution-type">Resolution Type (Optional)</Label>
