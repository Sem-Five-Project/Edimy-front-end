          ...
          <div className="text-center">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-center gap-2">
                <span
                  className={`w-2 h-2 rounded-full ${admin.enabled ? "bg-green-500" : "bg-red-500"}`}
                ></span>
        ...
        <Card className="lg:col-span-3 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              <div
                className={`w-3 h-3 rounded-full ${admin.enabled ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              <div>
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              <div
                className={`w-3 h-3 rounded-full ${admin.accountNonExpired ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              <div>
                <p className="text-sm font-medium text-dark dark:text-white">
                  Account Non-Expired
                ...
                <p className="text-xs text-dark-5 dark:text-dark-6">
                  {admin.accountNonExpired ? "Yes" : "No"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              <div
                className={`w-3 h-3 rounded-full ${admin.accountNonLocked ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              <div>
                <p className="text-sm font-medium text-dark dark:text-white">
                  Account Non-Locked
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              <div
                className={`w-3 h-3 rounded-full ${admin.credentialsNonExpired ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              <div>
                <p className="text-sm font-medium text-dark dark:text-white">
                ...
                <p className="text-xs text-dark-5 dark:text-dark-6">
                  {admin.credentialsNonExpired ? "Yes" : "No"}
                </p>
              </div>
            </div>
          </div>
