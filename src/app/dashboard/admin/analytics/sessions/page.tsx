...
export default function SessionTrendsPage() {
  ...
  const fetchSessionTrends = async () => {
    ...
    try {
      ...
      // Mock session data
      const mockSessionData: SessionData[] = Array.from(
        { length: 50 },
        (_, i) => {
          const subjects = [
            "Mathematics",
          ...
          const statuses: ("completed" | "cancelled" | "ongoing")[] = [
            "completed",
            "cancelled",
            "ongoing",
          ];
          ...
          return {
            ...
            rating:
              Math.random() > 0.3
                ...
                : undefined, // 4-5 stars or no rating
          };
        },
      );
  ...
  const filteredSessions = sessionData.filter((session) => {
    const matchesSubject =
      selectedSubject === "All Subjects" || session.subject === selectedSubject;
    const matchesSearch =
      searchTerm === "" ||
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="font-semibold text-blue-900">
                Mathematics is Leading
              </h4>
              <p className="text-sm text-blue-700">
                Mathematics sessions increased 15% this month with highest
                completion rate.
              </p>
            </div>
            ...
            <div className="p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-sm text-yellow-700">
                Weekend sessions grew 22%, indicating increased student
                availability.
              </p>
            </div>
          </div>
