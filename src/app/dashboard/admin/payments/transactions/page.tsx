          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-4">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="session_payment">
                    Session Payment
                  </SelectItem>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {selectedTransaction.tutor.name}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {selectedTransaction.tutor.email}
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    {selectedTransaction.metadata.duration && (
                      <p>
                        Duration: {selectedTransaction.metadata.duration}{" "}
                        minutes
                      </p>
                    )}
                  </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                value={newStatus}
                onValueChange={(value) =>
                  setNewStatus(value as TransactionStatus)
                }
              >
                <SelectTrigger>
                  <SelectValue />
      ...
      <Dialog open={showExportDialog} onOpenChange={setShowExportDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Export transaction data with current filters applied. The file
              will be downloaded as a CSV.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
