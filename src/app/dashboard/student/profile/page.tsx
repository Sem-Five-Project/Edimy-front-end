...
export default function ProfilePage() {
  ...
  const [editForm, setEditForm] = useState<
    Pick<AcademicInfo, "educationLevel" | "stream">
  >({
    educationLevel: "",
    stream: "",
  });
  ...
  const educationLevelLabel = useMemo(
    () =>
      EDUCATION_LEVELS.find((l) => l.value === (academic?.educationLevel ?? ""))
        ?.label ?? "Not set",
    [academic?.educationLevel],
  );
  const streamLabel = useMemo(
    () =>
      STREAMS.find((s) => s.value === (academic?.stream ?? ""))?.label ??
      "Not set",
    [academic?.stream],
  );
              ...
              <Card className="relative transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-slate-200 bg-white shadow-md overflow-hidden">
                <CardHeader className="relative z-10">
                  ...
                  <CardDescription className="text-slate-600 mt-2 text-base leading-relaxed">
                    Track all your payment transactions, invoices, and billing
            ...
            <div className="relative cursor-pointer group">
              <Card className="relative transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-slate-200 bg-white shadow-md overflow-hidden">
                <CardHeader className="relative z-10">
                  ...
                  <CardDescription className="text-slate-600 mt-2 text-base leading-relaxed">
                    Access your enrolled classes, study materials, and recorded
                    lecture videos
                  </CardDescription>
                </CardHeader>
              </Card>
            ...
            <div className="relative cursor-pointer group">
              <Card className="relative transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-slate-200 bg-white shadow-md overflow-hidden">
                <CardHeader className="relative z-10">
                  ...
                  <CardDescription className="text-slate-600 mt-2 text-base leading-relaxed">
                    View and manage your upcoming class schedules and
