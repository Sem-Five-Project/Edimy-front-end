...
//                 <CardDescription>
//                   Your active and upcoming sessions
//                 </CardDescription>
//               </div>
//               <Button
//                 variant="outline"
...
export default function StudentDashboard() {
  ...
  const { 
    ...
    queryFn: async () => {
      ...
      console.log("Bookings and stats loaded:", bookingsRes);
      return {
