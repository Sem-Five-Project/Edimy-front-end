...
import { Calendar as CalendarIcon, Clock, X, Plus, Trash2 } from "lucide-react";

const rangeDisabledTime = (now: Dayjs, type: "start" | "end") => {
  if (type === "start") {
    return {
...
const DateTimeSelectorComponent: React.FC<DateTimeSelectorProps> = ({
  filters,
  onFilterChange,
}) => {
  ...
  const handleDateSelection = (dates: Date[]) => {
    ...
    if (dates.length > 0) {
      ...
      if (
        ...
        !filters.selectedWeekdays.includes(selectedWeekday)
      ) {
            ...
            <div className="grid lg:grid-cols-1 xl:grid-raw-2 gap-4 sm:gap-6">
                ...
                <div className="border-2 border-gray-200 rounded-xl p-3 sm:p-4 bg-blue-500">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      caption:
                        "flex justify-center pt-1 sm:pt-2 md:pt-3 relative items-center px-1 sm:px-2 md:px-4",
                      caption_label:
                        "text-xs sm:text-sm md:text-base font-medium",
                      nav: "space-x-1 sm:space-x-2 flex items-center",
                      nav_button:
                        "h-6 sm:h-7 md:h-8 w-6 sm:w-7 md:w-8 bg-transparent p-0 hover:bg-blue-100 dark:hover:bg-blue-900/20 transition-all duration-200 rounded-full focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400",
              ...
              <Card className="w-full shadow-md rounded-2xl p-4 sm:p-6">
                ...
                <p className="text-gray-500 mb-4 sm:mb-6 text-sm sm:text-base">
                  ...
                  <span className="font-medium">end</span> time you can attend
                  class.
                </p>
          ...
          <div className="space-y-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Select weekdays to set recurring time slots for all{" "}
            ...
            <div className="space-y-4 bg-blue-500 p-3 sm:p-4 rounded-xl border-2 border-blue-100">
              ...
              <WeekCalendar
                ...
                classNames={{
                  ...
                  caption:
                    "flex justify-center pt-1 sm:pt-2 relative items-center px-1 sm:px-2",
                  caption_label: "text-xs sm:text-sm font-medium",
                  nav: "space-x-1 sm:space-x-2 flex items-center",
                  nav_button:
                    "h-5 sm:h-6 md:h-7 w-5 sm:w-6 md:w-7 bg-transparent p-0 hover:bg-blue-100 transition-all duration-200 rounded-full",
                  table: "w-full border-collapse space-y-1",
                  head_row: "flex",
                  head_cell:
                    "text-muted-foreground rounded-md w-6 sm:w-7 md:w-8 font-normal text-[0.6rem] sm:text-[0.7rem] text-center py-1",
                  ...
                  day_selected:
                    "bg-blue-600 text-white hover:bg-blue-700 focus:bg-blue-700 rounded-full font-medium",
                  day_today:
                    "bg-blue-100 text-blue-900 font-semibold border border-blue-500 rounded-full",
                  day_outside: "text-muted-foreground opacity-50",
                  day_disabled: "text-muted-foreground opacity-50",
                  day_hidden: "invisible",
                }}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {!filters.addingNewSlot &&
                  filters.selectedWeekdays.length < 4 && (
                    <Button
                ...
                filters.selectedWeekdays.map((weekday) => {
                  ...
                  return (
                    <div
                      key={weekday}
                      ref={(el) => {
                        weekdayRefs.current[weekday] = el;
                      }}
                          ...
                          <div className="flex items-center justify-between p-2 sm:p-3 bg-green-50 border border-green-200 rounded-lg">
                            <div>
                              <span className="font-medium text-green-800 text-sm sm:text-base">
                                ...
                                {formatTimeRange(
                                  filters.timePeriods[weekday].startTime,
                                  filters.timePeriods[weekday].endTime,
                                )}
                              </span>
                              <p className="text-xs text-green-600 mt-1">
                                Applies to all {WEEKDAYS[weekday]}s in{" "}
                                {currentMonth.toLocaleString("default", {
                                  month: "long",
                                })}
                              </p>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-gray-50/60 dark:bg-gray-800/40 p-4 space-y-4 shadow-sm">
                          ...
                          <div className="flex justify-center">
                            <Button
                              ...
                              disabled={
                                !filters.tempTimeSelection?.[weekday]
                                  ?.startHour ||
