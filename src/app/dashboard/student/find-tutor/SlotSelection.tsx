...
export const SlotSelection: React.FC<SlotSelectionProps> = ({
  ...
  const [bookingPreferences, setBookingPreferences] =
    useState<BookingPreferences>({
      selectedLanguage:
        tutor.languages.length === 1 ? tutor.languages[0] : null,
            ...
            <CardTitle className="flex items-center gap-3 text-2xl text-white">
              ...
              <div>
                ...
                <div className="text-sm text-purple-200 font-normal mt-1">
                  Tailor your perfect learning session
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Select
                    value={
                      bookingPreferences.selectedLanguage?.languageId.toString() ||
                      ""
                    }
                    onValueChange={(value) => {
                      const language = tutor.languages.find(
                        (l) => l.languageId.toString() === value,
                      );
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Select
                    value={
                      bookingPreferences.selectedSubject?.subjectId.toString() ||
                      ""
                    }
                    onValueChange={(value) => {
                      const subject = tutor.subjects.find(
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <Select
                    value={String(
                      bookingPreferences.selectedClassType?.id || "",
                    )}
                    onValueChange={(value) => {
                      const classType = CLASS_TYPES.find(
                        (ct) => ct.id === Number(value),
                      );
                      setBookingPreferences((prev) => ({
                        ...prev,
                  ...
                  >
                    ...
                    <SelectContent className="bg-slate-900 border-slate-700 text-white">
                      {CLASS_TYPES.map((classType) => (
                        <SelectItem
                          key={classType.id}
                          value={String(classType.id)}
                          className="hover:bg-slate-800 py-3"
                        >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              {classType.priceMultiplier < 1.0 && (
                                <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs px-2 py-1">
                                  {Math.round(
                                    (1 - classType.priceMultiplier) * 100,
                                  )}
                                  % OFF
                                </Badge>
                              )}
