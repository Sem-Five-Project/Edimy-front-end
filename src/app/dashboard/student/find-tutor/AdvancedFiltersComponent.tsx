...
const AdvancedFiltersComponent: React.FC<AdvancedFiltersProps> = ({ filters, onFilterChange }) => {
  ...
  const adjustPrice = (increment: number) => {
    const newPrice = Math.min(5000, Math.max(500, (filters.maxPrice || 2000) + increment));
    onFilterChange('maxPrice', newPrice);
  };

  // Rating adjustment handlers
  const adjustRating = (increment: number) => {
    const newRating = Math.min(5, Math.max(0, (filters.minRating || 0) + increment));
    onFilterChange('minRating', newRating);
  };

  // Experience adjustment handlers
  const adjustExperience = (increment: number) => {
    const newExp = Math.min(240, Math.max(0, (filters.minExperience || 0) + increment));
      ...
      <CardContent className="p-6 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between text-xs text-gray-500">
              <span>Rs. 500</span>
              <span className="text-center">Use slider or +/- buttons (±Rs. 500)</span>
              <span>Rs. 5,000</span>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between text-xs text-gray-500">
              <span>0 stars</span>
              <span className="text-center">Use slider or +/- buttons (±0.5 stars)</span>
              <span>5 stars</span>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs text-gray-500">
              <span>0 months</span>
              <span className="text-center">Use slider or +/- buttons (±1 month)</span>
              <span>20 years</span>
            </div>
        ...
        <div className="space-y-4 pt-4 border-t border-gray-200">
          ...
          <div className="p-3 bg-gray-50 rounded-lg text-sm text-gray-600">
            <strong>Current sort:</strong> {filters.sortBy} ({filters.sortOrder === 'desc' ? 'highest' : 'lowest'} first)
          </div>
        </div>
      </CardContent>
    </Card>
