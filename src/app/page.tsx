          ...
          <div className="text-center space-y-8 py-20">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Transform your learning experience with our innovative
                educational platform. Discover, learn, and grow with
                cutting-edge tools designed for modern education.
              </p>
            </div>
          ...
          <div className="py-20">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Discover the features that make learning engaging, effective,
                and enjoyable
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  real-time feedback to enhance your learning experience.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  progress reports, and personalized insights.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Connect with peers, join study groups, and learn together in a
